...
void InitHighRes()
{
    int specWidth = SpawnIniGetInt("Settings", "GameWidth", 0);
    int specHeight = SpawnIniGetInt("Settings", "GameHeight", 0);
    if (specWidth && specHeight)
    {
        GameWidth = specWidth;
        GameHeight = specHeight;
        SpawnIniSetInt("Settings", "GameWidth", 0);
        SpawnIniSetInt("Settings", "GameHeight", 0);
    }
    else
    {
